...
class WyvernProtocol {
    ...
    getAuthenticatedProxy(accountAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            const proxyAddress = yield this.wyvernProxyRegistry.proxies.callAsync(accountAddress);
            return new authenticated_proxy_1.AuthenticatedProxyContract(this._web3Wrapper.getContractInstance(constants_1.constants.AUTHENTICATED_PROXY_ABI, proxyAddress), {});
        });
    }
    /**
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const txReceiptPromise = new Promise((resolve, reject) => {
                const intervalId = utils_1.intervalUtils.setAsyncExcludingInterval(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const transactionReceipt = yield this._web3Wrapper.getTransactionReceiptAsync(txHash);
